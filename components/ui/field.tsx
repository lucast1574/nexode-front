...
function FieldLegend({ className, variant = "legend", ...props }: React.HTMLAttributes<HTMLLegendElement> & { variant?: "legend" | "label" }) {
    return (
        <legend
...
function Field({ className, orientation = "vertical", ...props }: React.HTMLAttributes<HTMLDivElement> & VariantProps<typeof fieldVariants>) {
    return (
        <div
            role="group"
            data-slot="field"
...
function FieldSeparator({ children, className, ...props }: React.HTMLAttributes<HTMLDivElement> & { children?: React.ReactNode }) {
    return (
        <div
...
function FieldError({ className, children, errors, ...props }: React.HTMLAttributes<HTMLDivElement> & { errors?: { message?: string }[] }) {
