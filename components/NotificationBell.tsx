    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                {unviewedCount > 0 && (
                    <span className="absolute top-2.5 right-2.5 px-1.5 py-0.5 min-w-[18px] h-[18px] bg-primary text-white text-[10px] font-black rounded-full border-2 border-[#020202] flex items-center justify-center">
