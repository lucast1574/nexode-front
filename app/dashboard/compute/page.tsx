                                ...
                                instances.map((inst) => (
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-2">
                                            <div>
                                                {inst.type.toLowerCase() === 'frontend' ? <Globe className="size-5 text-muted-foreground" /> : <Server className="size-5 text-muted-foreground" />}
                                            </div>
                                            <div className={cn(
                                        ...
                                        <div>
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                <Badge variant="outline" className={cn(
                                                    "text-xs font-medium",
                                                    selectedInstance.status === 'running' ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20' :
